...
<template>
  ...
  <Card>
        ...
        <form id="expenseForm" class="rowForm" @submit.prevent="addExpense">
            <input id="descInput" placeholder="Expense Description" v-model="newExpense.description"/>
            <input id="amountInput" placeholder="Amount" v-model="newExpense.amount"/>
            <select id="paidBySelect" v-model="newExpense.paidBy"></select>
